<div class="navbar-default sidebar" role="navigation" >
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-briefcase fa-fw"></i> Thể Loại<span class="fa arrow"></span></a>
    ...
    <!-- /.sidebar-collapse -->
</div><?php /**PATH C:\xampp\htdocs\laravel_demo\resources\views/admin/layout/menu.blade.php ENDPATH**/ ?>