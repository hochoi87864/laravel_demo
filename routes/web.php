...
Route::get('loaitin/{id}/{tenkhongdau}.trungle','PageController@loaitin');
Route::get('tintuc/{id}/{tenkhongdau}.trungle','PageController@tintuc');
Route::get('dangnhap','PageController@getDangNhap');
Route::post('dangnhap','PageController@postDangNhap');
Route::get('dangxuat','PageController@dangxuat');
Route::post('binhluan/{id}','CommentController@binhluan');
