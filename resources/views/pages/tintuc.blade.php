            ...
            <div class="row">
                ...
                <p><span class="glyphicon glyphicon-time"></span> {{$tintuc->created_at}}</p>
                    ...
                    <div class="well">
                        ...
                        <form role="form" method="post" action="binhluan/{{$tintuc->id}}">
                                {{csrf_field()}}
                        ...
                        <div class="panel-body">
                            ...
                            @foreach ($tinlienquan as $tlq)
                                <div class="row" style="margin-top: 10px;">
                                    ...
                                    <p><a href="tintuc/{{$tlq->id}}/{{$tlq->TieuDeKhongDau}}.trungle">{{$tlq->TieuDe}}</a></p>
                                    <div class="break"></div>
                                </div>
                            @endforeach
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-top: 10px;">
                                ...
                                <p><a href="tintuc/{{$tnb->id}}/{{$tnb->TieuDeKhongDau}}.trungle">{{$tnb->TieuDe}}</a></p>
                                <div class="break"></div>
                                </div>
                            @endforeach  
                            <!-- end item -->
